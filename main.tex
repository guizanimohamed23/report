...
% -------- Chapter 3 --------
\chapter{Backend Foundation \& Authentication (Sprint 1)}
\input{chapitres/chapitre3}

% -------- Chapter 4 --------
\chapter{Scan Processing Pipeline \& Normalization (Sprint 2)}
\input{chapitres/chapitre4}

% -------- Chapter 5 --------
\chapter{Attack Graph Generation (Sprint 3)}
\input{chapitres/chapitre5}

% -------- Chapter 6 --------
\chapter{HexStrike Internals, AI Integration \& Experimental Validation}
