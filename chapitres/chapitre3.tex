...
% Inline sequence diagram to avoid float-induced page breaks
\begin{center}
    \includegraphics[width=0.90\textwidth]{uploads/diagrams/sprint 1 sequence.drawio.png}\\
    \captionsetup{skip=2pt}
    \captionof{figure}{Sequence diagram for authentication and access control}\label{fig:sprint1-sequence-diagram}
\end{center}
