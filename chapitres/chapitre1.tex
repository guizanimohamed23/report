...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.25\textwidth]{uploads/logos/logo.png}
...
The vision of \textbf{CyberScope} is to provide an enterprise-oriented web application security auditing platform that helps security analysts detect, understand, and prioritize vulnerabilities more efficiently.

The main objectives of the project are:

\begin{itemize}
    \item automate the execution of several open-source security tools within a unified workflow;
    \item improve the analysis of modern dynamic applications through browser-based exploration;
    \item reduce duplicated and redundant findings through normalization and deduplication;
    \item provide clearer vulnerability interpretation using AI-assisted analysis;
    \item present results through a professional dashboard and generate structured audit reports.
\end{itemize}
