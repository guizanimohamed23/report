...
CyberScope is organized into three iterative sprints, each with distinct objectives and deliverables. Table~\ref{tab:sprint-organization} presents the sprint timeline and main goals, showing how the project progresses from backend infrastructure through tool integration to advanced attack graph generation over a 12-week development cycle.
