...
\indent\justify To support roadmap planning, user stories were estimated using the T-shirt sizing approach, with categories ranging from XS to XL. Instead of assigning numerical points, this method focuses on relative effort, which makes it easier to compare complexity across items at a glance. The sizing scale adopted for this project is shown in Figure~\ref{fig:tshirt-sizing}.
